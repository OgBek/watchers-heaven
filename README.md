...
| `NEXT_PUBLIC_SUPABASE_URL` | ✅ |Your supabse project url  for watchparty integration |
| `NEXT_PUBLIC_SUPABASE_PUBLISHABLE_KEY` | ✅ |Your supabse API key for watchparty integration |
